...
//         $this->assign('jssdk', $jssdk);
     ...
     * 财务记录 赠送
     */
    public function _account_award(){
     ...
     * 漫画分类
     */
    public function _account_income(){
     ...
     * 我的账户
     */
    public function _account_index(){
     ...
     * 我的账户  成长体系
     */
    public function _account_level(){
     ...
     * 财务记录  充值
     */
    public function _account_recharge(){
...
//         $this->assign('jssdk', $jssdk);
     ...
     * 我的消息
     */
    public function _message_index(){
    	$cond = array();
     ...
     * 建议反馈操作
     */
    public function _my_feedbackdo(){
	...
	public function  _payChinaxingChange(){
			$sn = I('get.sn');
		  $order = M('charge')->where(array('sn'=>$sn))->find();
   ...
   public function _paySend(){
	...
	//ajax查询订单状态
	public function _getOrderStatus(){
		if(IS_POST){
			$sn = I('post.sn');
    ...
    //提现记录
    public function _withdraw_recode(){
    	$user = M('user')->where(array("id"=>$this->user['id']))->find();

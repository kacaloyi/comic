...
<!------------------------------------->
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            ...
            <span class="pagedesc">查看商城中的用户充值记录</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
			...
			<?php if($_GET['status'] == ''): ?>总充值数：<?php echo ($orders_paid); ?>/<?php echo ($orders); ?>,
			总金额：￥<?php echo ($total_paid); ?>/￥<?php echo ($total); ?>,
			微信支付：￥<?php echo ((isset($wxpay) && ($wxpay !== ""))?($wxpay):0); ?>，
			余额支付：￥<?php echo ((isset($money) && ($money !== ""))?($money):0); ?>，
			<?php echo ($_CFG["site"]["points_name"]); ?>支付：￥<?php echo ((isset($points) && ($points !== ""))?($points):0); ?>
			<?php else: ?>
			总充值数：<?php echo ($orders); ?>,

...
<!------------------------------------->
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            ...
            <span class="pagedesc">欢迎使用EFUCMS漫画小说分销系统管理后台</span>
            
        </div><!--pageheader-->
        
        <div id="contentwrapper" class="contentwrapper lineheight21">
			
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable"   style="background:#fff">
				<colgroup>
					<col class="con0" />
					<col class="con1" />
					<col class="con0" />
				...
				<tbody>				
					<tr>
						<td width="15%">今日订单数</td>
						<td width="35%"><?php echo ($info["orders_total"]); ?></td>
						<td width="15%">今日销售额</td>
						<td width="35%"><?php echo ($info["total_today"]); ?></td>
					</tr>
					<tr>
						<td width="15%">今日余额支付总额</td>
						<td width="35%"><?php echo ($info["money_pay"]); ?></td>
						<td width="15%">今日积分支付总额</td>
						<td width="35%"><?php echo ($info["points_pay"]); ?></td>
					</tr>
					<tr>
						<td width="15%">今日微信支付总额</td>
						<td width="35%"><?php echo ($info["wxpay_pay"]); ?></td>
						<td width="15%"></td>
						<td width="35%"></td>
					</tr>
					<tr>
						<td width="15%">待结算佣金</td>
						<td width="35%"><?php echo ($info["expense1"]); ?></td>
						<td width="15%">已结算佣金</td>
						<td width="35%"><?php echo ($info["expense4"]); ?></td>
					</tr>
					<tr>
						<td width="15%">会员积分总额</td>
						<td width="35%"><?php echo ($info["points_total"]); ?></td>
						<td width="15%">会员余额总额</td>
						<td width="35%"><?php echo ($info["money_total"]); ?></td>
					</tr>
				</tbody>
			</table>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="stdtable"  style="background:#fff">
        <thead>
        <tr>
            <th colspan="4" scope="col">EFUCMS系统--服务器当前日期【<?php echo date('Y-m-d'); ?>】
              <?php if($_SERVER['SCRIPT_NAME'] == '/efucms.php'): ?><a style="color:red; line-height:40px; padding:30px 0;">	您使用的是默认后台入口文件，强烈将以您将网站根目录下的efucms.php修改为其他不容易被猜到的名字，比如efucms<?php echo mt_rand(1000,9999);?>.php</a><?php endif; ?>
             </th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr>
            <td colspan="4">当前版本：<span class="layui-badge">10.6版    </span> 授权类型：<span class="layui-badge">商业版</span></td>
        </tr>
        </tbody>
    </table>
    </div>

...
<!------------------------------------->
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">动漫管理</h1>
            <span class="pagedesc">对动漫进行增加，修改或者删除等操作</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
			...
			<div class="tableoptions">                    
				<button class="radius3" onclick="location.href='<?php echo U('edit');?>'">添加动漫</button>
			</div><!--tableoptions-->

			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						<th class="head1" style="width:50px;">动漫ID</th>
						<th class="head1">动漫标题</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="background:#fff">
						...
						<td><a href="<?php echo U('episodes');?>&vid=<?php echo ($vo["id"]); ?>">进入分集</a></td>

...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">动漫分类设置</h1>
            <span class="pagedesc">动漫分类设置的增加、删除、修改(若显示在主页列表，不需要设置跳转链接)</span>
        </div><!--pageheader-->
            ...
            <form class="stdform stdform2" method="post">
				...
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <tbody>
                    	...
                    	<?php if(is_array($_video)): $i = 0; $__LIST__ = $_video;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="background:#fff">
                            <td>

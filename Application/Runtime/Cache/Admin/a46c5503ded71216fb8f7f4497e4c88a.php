...
<div class="bodywrapper">
    ...
    <div class="centercontent">
            ...
            <h1 class="pagetitle">编辑动漫</h1>
            <span class="pagedesc">请认真编辑动漫的各项信息</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post" enctype="multipart/form-data">
				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						<th class="title">动漫首页分类</th>
						<td>
							<?php if(is_array($_video)): foreach($_video as $k=>$v): if($v['show'] == 2): ?><input type="checkbox" name="bookcate[]" id="bookcate" value="<?php echo ($k); ?>"  <?php if(in_array($k, $bookcate)): ?>checked<?php endif; ?> /><?php echo ($v['name']); ?>&nbsp;&nbsp;&nbsp;<?php endif; endforeach; endif; ?>
						</td>
					</tr>
					<tr>
						<th class="title">动漫分类</th>
						<td>

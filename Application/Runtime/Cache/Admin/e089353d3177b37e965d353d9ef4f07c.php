...
<p>
				...
				<p>
					<label>小说文件根目录<small></small></label>
					<span class="field"><input type="text" name="txtdir" id="txtdir" value="<?php echo ($_CFG["site"]["txtdir"]); ?>" class="smallinput" /></span>
				</p>
				<p>
					<label>漫画文件根目录<small></small></label>
					<span class="field"><input type="text" name="imgdir" id="imgdir" value="<?php echo ($_CFG["site"]["imgdir"]); ?>" class="smallinput" /></span>
				</p>

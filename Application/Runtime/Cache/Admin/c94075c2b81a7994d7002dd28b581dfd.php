				...
				<div style="float: left;margin-left: 10px">
					<form method="post" class="clearfix">
						<div class="input-group input-group-sm" style="width: 200px;float: left;margin-left: 5px">
							<input type="text" name="keyword" class="form-control" value="<?php echo ($_GET['keyword']); ?>" id="keyword" style="width: 200px" placeholder="推广名称/书名/备注">
						</div>
						<div class="input-group input-group-sm" style="width: 200px;float:left;margin-left:5px;">
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</div>
							<input type="text" class="form-control date" name="time1" placeholder="开始时间" value="<?php echo ($_GET['time1']); ?>">
						</div>
						<div class="input-group input-group-sm" style="width: 200px;float:left;margin-left:5px;">
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</div>
							<input type="text" class="form-control date" name="time2" placeholder="结束时间" value="<?php echo ($_GET['time2']); ?>">
						</div>
				...
				<table class="table table-bordered table-hover table-striped text-center">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
							...
							<td><?php echo sprintf("%.2f",$v['subnums']/$v['pernums']*100);?>%</td>
							<td><?php echo ($v["charge"]); ?></td>
							<td><?php echo sprintf("%.2f",$v['charge']/$v['pernums']*100);?>%</td>
							<td><?php echo ($v["msg"]); ?></td>
							<td><?php echo (date("Y-m-d H:i:s",$v["create_time"])); ?></td>
							<td>
								<a href="<?php echo U('Chapter/editChapter',array('id'=>$v['id']));?>" class="btn btn-xs btn-info">

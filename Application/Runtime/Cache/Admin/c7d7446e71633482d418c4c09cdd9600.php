				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						...
						<td>
							...
							<input type="checkbox" name="arrcateids[]" id="arrcateids4" value="4"  <?php if(in_array(4, $arrcateids)): ?>checked<?php endif; ?> />历史&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids5" value="5"  <?php if(in_array(5, $arrcateids)): ?>checked<?php endif; ?> />网游&nbsp;&nbsp;&nbsp;
							...
							<input type="checkbox" name="arrcateids[]" id="arrcateids8" value="8"  <?php if(in_array(8, $arrcateids)): ?>checked<?php endif; ?> />女频&nbsp;&nbsp;&nbsp;
						</td>
						</td>
						</td>
					</tr>

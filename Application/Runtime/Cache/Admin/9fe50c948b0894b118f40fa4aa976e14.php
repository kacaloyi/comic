...
<!------------------------------------->
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">用户树形关系</h1>
            <span class="pagedesc">在这里你可以直观的了解到用户间的上下级关系</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21" style="background:#fff">
			<div>
				<form method="post">
				上级ID:<input type="text" style=" width:50px;" name="id" />
				<input type="submit" value="提交" />
				
				</form>
			</div>
			<link rel="stylesheet" href="/Public/plugins/zTree_v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
			<script type="text/javascript" src="/Public/plugins/zTree_v3/js/jquery.ztree.core-3.5.js"></script>
			<!--script src="//twemoji.maxcdn.com/twemoji.min.js"></script-->
			<div id="tree" class="ztree"></div>
			<SCRIPT type="text/javascript">
			<!--
			var root = "<?php echo ((isset($_POST['id']) && ($_POST['id'] !== ""))?($_POST['id']):0); ?>";
			var setting = {
				async: {
					enable: true,
					url:"<?php echo U('get_users');?>",
					autoParam:["id", "name=n", "level=lv"],
					otherParam:{"root":root},
					dataFilter: filter
				}
			};

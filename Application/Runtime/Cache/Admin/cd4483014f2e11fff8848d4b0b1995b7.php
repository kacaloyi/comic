        ...
        <div id="contentwrapper" class="contentwrapper lineheight21" style="background:#fff">
			...
			<div class="tableoptions">                    
				<!--<button class="radius3" onclick="location.href='<?php echo U('edit');?>'">添加代理</button>-->
                    <button class="radius3"><a href="/index.php?m=&c=Public&a=regist" target="_blank">代理申请</a></button>
                    <button class="radius3"><a href="/daili.php" target="_blank">代理登录</a></button>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a>代理只能通过申请才能正常使用，请勿后台添加代理！</a>
			</div>

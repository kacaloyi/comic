...
<head>
    ...
    <title><?php echo ($_CFG['site']['name']); ?>_免费好看的漫画大全网</title>
    <meta name="keywords" content="漫画大全,漫画图片,漫画投稿,在线漫画,斗破苍穹漫画,斗罗大陆漫画,偷星九月天,穿越西元3000后,凤逆天下,风起苍岚,妃夕妍雪,BL漫画,耽美漫画,知音漫客,飒漫画,漫画下载" />
    <meta name="description" content="<?php echo ($_CFG['site']['name']); ?>最好看的免费漫画在线看，斗破苍穹漫画、斗罗大陆漫画，更有APP和漫画下载等精彩内容等你发现，免费看漫画，就来<?php echo ($_CFG['site']['name']); ?>！" />
    <!-- 共用引入资源.开始 -->
...
<div class="br-box free-box rank-view clearfix">
    ...
    <div class="list clearfix" id="html_box" style="min-height: 740px;">
        ...
        <a href="<?php echo U('Mh/'.$vo['id']);?>" class="clearfix">
            <div class="cover">
...
<script id="itemTpl" type="text/html">
    ...
    <div class="item clearfix">
        <a href="<?php echo U('Book/'.$data.book.id);?>" class="clearfix">
            <!--<div class="cover">

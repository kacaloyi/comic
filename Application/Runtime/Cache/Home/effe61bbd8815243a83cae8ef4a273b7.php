...
<!-- saved from url=(0043)https://m.efucms.com/rank/book_hot.html -->
...
<a class="toback tobackbg-rank" href="<?php echo U('index');?>"></a>
<!-- 漫画人气排行 -->
<div class="br-box bh-box rank-view clearfix">
    <div class="tl"><i class="wbg"></i>
        <!--
        <span class="times">下次出榜时间：07月30日 10:00</span>
         -->
    </div>
    <div class="list clearfix" id="html_box" style="min-height: 745px;">
        <!-- <div class="item clearfix"><a href="https://m.efucms.com/book/10058/" class="clearfix">
            <div class="cover"><img width="75" height="100" class=""
                                    href="/Public/home/mhimages/5a22296c60968.jpg"
                                    data-original="https://p.efucms.com/uploads/book/201712/5a22296c60968.jpg"
                                    style="background: rgb(238, 238, 238); display: block;"></div>
            <div class="body">
                <div class="title">我在殡仪馆工作的那些事儿</div>
                <div class="col">
                ...
                <div class="col"><label class="tag">都市</label><label class="tag" style="margin-left:4px;">悬疑</label>
                </div>
                <div class="col">更新至：第56话 大家小心</div>
            </div>
        </a></div> -->
        ...
        <a href="<?php echo U('Yook/'.$vo['id']);?>" class="clearfix">
            <div class="cover">

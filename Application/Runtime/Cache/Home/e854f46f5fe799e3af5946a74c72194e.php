...
<html data-dpr="1" style="font-size: 43.1px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title><?php echo ($_CFG['site']['name']); ?>_书架</title>
...
<div class="bs-box" style="bottom: 1.333rem;margin-bottom: 0px;">
    <div class="column-list" id="shelf-container">
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
				...
				<div class="action">
					<?php if($vo['type'] == 'mh'): ?><a href="<?php echo U('Mh/'.$vo['rid'].'/'.$vo['episodes']);?>" class="btn">续看</a>
					<?php else: ?>
						<a href="<?php echo U('Book/'.$vo['rid'].'/'.$vo['episodes']);?>" class="btn">续看</a><?php endif; ?>
				</div>
...
<div class="tabar flb" id="footer_nav">
    <nav class="nav hls1">
        <div class="item">
            <a href="<?php echo U('Mh/book_recent_read');?>" class="active">

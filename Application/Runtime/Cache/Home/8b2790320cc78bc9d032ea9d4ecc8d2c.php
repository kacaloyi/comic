...
<div class="contact-box mt-10" data-type="default">
 ...
 <div class="row">1. 分享你的推广二维码，你将获得：通过此二维码进入充值的客户的30%提成佣金。</div>
  <div class="row">
2. 你的推广二维码获取方式：点击下方菜单“用户中心-个人中心-我的推广二维码”即可获取推广二维码，然后点击右上角将二维码分享给朋友、群、朋友圈。</div> <div class="row">
3. 有人通过你分享的二维码关注公众号的，则该用户为你的推广用户。</div> <div class="row">
4. 你将永久获得：通过此二维码进入充值的客户的30%提成，不限充值次数和时间。</div> <div class="row"></div> <div class="row">
5. 推广二维码分享后，你可以在：“个人中心—我的推广用户”中查看通过此推广二维码进入的客户和客户充值的金额。然后在“申请提现”中可以申请提现。</div> <div class="row">
6.申请提现三个工作日内到账。</div>
 <div class="row"></div>
    <div class="row">如有疑问，请联系客服QQ：  <label class="label"><a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($_CFG["site"]["kfqq"]); ?>&site=qq&menu=yes"><?php echo ($_CFG["site"]["kfqq"]); ?></a></label></div>

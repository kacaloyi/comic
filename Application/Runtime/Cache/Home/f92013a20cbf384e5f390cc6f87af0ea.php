...
<meta name="viewport" content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no">
    <title><?php echo ($_CFG['site']['name']); ?>_漫画人气榜</title>
...
<div class="books-classify">
	<div>
		<div class="bcigy-item" _order="reader" onclick="location.href=&#39;<?php echo U('Mh/book_hot').'?order=reader';?>&#39;">
			人气榜
		</div>
		<div class="bcigy-item" _order="time" onclick="location.href=&#39;<?php echo U('Mh/book_hot').'?order=time';?>&#39;">
			最新上架
		</div>
		<div class="bcigy-item" _order="overs" onclick="location.href=&#39;<?php echo U('Mh/book_hot').'?order=overs';?>&#39;">
			完结榜
		</div>
	</div>
	<div>
		<div class="bcigy-item" _order="free" onclick="location.href=&#39;<?php echo U('Mh/book_hot').'?order=free';?>&#39;">
			免费榜
		</div>
		<div class="bcigy-item" _order="cate1" onclick="location.href=&#39;<?php echo U('Mh/book_hot').'?order=cate1';?>&#39;">
			男生榜
		</div>
		<div class="bcigy-item" _order="cate2" onclick="location.href=&#39;<?php echo U('Mh/book_hot').'?order=cate2';?>&#39;">
			女生榜
		</div>
	</div>
</div>
<div class="books-res" id="html_box" name="top">
	<?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="item">
		<a href="<?php echo U('Mh/'.$v['id']);?>" class="link">
			<div class="cover">
		...
		<div class="action">
			<a href="<?php echo U('Mh/'.$v['id']);?>" class="btn">阅读</a>
		</div>

    ...
    <div class="shrink open-box condition-box" style="display: block;">
        <div class="row has-label">
            ...
            <div class="container open-type">
                ...
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=4" type="tid" val="4" <?php if($cateid == 4): ?>class="active"<?php endif; ?> id="open-4">历史</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=5" type="tid" val="5" <?php if($cateid == 5): ?>class="active"<?php endif; ?> id="open-5">网游</a></div>
                ...
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=8" type="tid" val="8" <?php if($cateid == 8): ?>class="active"<?php endif; ?> id="open-8">女频</a></div>
            </div>
        </div>
        <div class="row has-label">

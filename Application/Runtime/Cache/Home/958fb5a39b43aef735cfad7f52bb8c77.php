...
<html>
<head>
    <title><?php echo ($_CFG['site']['name']); ?>小说搜索_无弹窗书友最值得收藏的网络小说阅读网</title>
...
<div class="search-bar search-multiple">
  <div class="inner">
    <div class="field">
      ...
      <input type="text" placeholder="输入小说名或作者" id="search_keyword" maxlength="18" value="<?php echo ($key); ?>" onkeyup="keyup_search(this);"/>
    </div>
...
<div class="books-res" id="search-result-container" >
    ...
    <a href="<?php echo U('Book/'.$vo['id']);?>" class="link">
      <div class="cover">
    ...
    <div class="action">
      <a href="<?php echo U('Book/'.$vo['id']);?>" class="btn">阅读</a>
    </div>
...
<script>
	...
	function key_search_hrefs() {
		...
		hide_ser_box();
		window.location.href = "/Book/search.html?key="+key_v;
	}
    </script>
<!-- 统计 -->

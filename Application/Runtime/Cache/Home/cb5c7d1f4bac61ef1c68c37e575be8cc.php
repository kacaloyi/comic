...
<div class="uh-box" style="height: 4rem;overflow: hidden;">
    ...
    <div class="container">
        ...
        <div class="body">
    		...
    		<!--<div class="action">
    			<a href="<?php echo U('Member/withdraw');?>" class="btn btn-sign" style="color:#2196F3">申请提现</a>
    		</div>
    		<div class="action">
  ...
  <script>
	function SignOn(ob){
		...
		$.post("<?php echo U('Member/sign');?>",function(d){
			$("#bh_msg_lay").remove();
			if(d){
				if(d.status){
					bh_msg_tips(d.info);
...
<div class="uh-row" style="position: relative;">
    <div class="col" onclick="javascript:void(0);">
       <a href="<?php echo U('Member/pay');?>" class="btn">
...
<div class="uh-nav mb-10 mb-tabar" style="clear:both">
    ...
    <div class="item mt-10">
        ...
        <div class="action"> 
    			<?php if(($sign == true)): ?><a href="javascript:void(0)" class="btn" style="color:#FF5722">已签到</a>
    			<?php else: ?>
    ...
    <div class="item tl">
        <a href="<?php echo U('Member/pay');?>" class="link">
    ...
    <div class="item tl">
      <a href="<?php echo U('Member/record');?>" class="link">
        <i class="icon-buy"></i>
     ...
     <div class="item tl">
      <a href="<?php echo U('Member/my_tuiguang');?>" class="link">
        <i class="icon-shop"></i>
        <div class="title">任务中心</div> <font size="-1" color="#D7BA6F" style="margin: 0 0.2rem;" >做任务赚VIP</font>
         <div class="text">
                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 14 24"><title>right-arrow</title><path d="M1.91 1.93L12.06 12 1.91 22" fill="none" stroke="#888888" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
         </div> 
      </a>
    ...
    <!--<div class="item tl">
        <a href="<?php echo U('Member/pay');?>" class="link">
            ...
            <div class="action">
            <a href="<?php echo U('Member/pay');?>" class="btn">充值书币</a>
        </div>
        </a>
    </div> ->
...
<!--    <div class="item mt-10">
        <a href="<?php echo U('Member/myTeam');?>" class="link">
            <i class="icon-level"></i>  
    ...
    <div class="item tl">
        <a href="<?php echo U('Member/qrcode');?>&id=<?php echo ($user['id']); ?>" class="link">
            <i class="icon-shop"></i>
 ...
 -->
    <div class="item tl">
        <a href="<?php echo U('Member/look',array('sc'=>$user['username']));?>" class="link">
            <i class="icon-level"></i>
            <div class="title" style="color:#FF5722">点击收藏网址发布页，防走失【重要】</div>
            <div class="text">
                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 14 24"><title>right-arrow</title><path d="M1.91 1.93L12.06 12 1.91 22" fill="none" stroke="#888888" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
            </div> 
        </a>
	...
	<div class="item tl">
        <a href="<?php echo U('Member/message_index');?>" class="link">
    ...
    <div class="item tl">
        <a href="<?php echo U('Member/my_feedback');?>" class="link">
            <i class="icon-feedback"></i>
    ...
    <div class="item tl">
        <a href="<?php echo U('Member/help');?>" class="link">
...
<!--    <div class="item tl">
        <a href="<?php echo U('Member/bangding');?>" class="link">
            <i class="icon-feedback"></i>
    ...
    <div class="item mt-10">  
        <a href="<?php echo U('Member/password');?>" class="link">
            <i class="icon-feedback"></i>
...
<div class="tabar flb">
    <nav class="nav hls1">
       ...
       <div class="item">
        ...
        <div class="item">
            <a href="<?php echo U('Member/my');?>" class="active">
...
<script type="text/javascript">
    $(function(){
        ...
        $("#switch-auto-buy").click(function(){
            ...
            AjaxJson("/Member/switchAutoBuy",{autoPay:autoPay,random:+(new Date)},function(res){
    ...
    function sign_in(){
        ...
        is_request = true;
        AjaxJson("/Member/ajax_sign",{random:+(new Date)},function(res){
            is_request = 0;
            if(res.status*1 == 1){

...
<div class="rt-tabs mt-10 tab">
    <div class="item">
		<a class="active" data-type="0">消费</a>
	</div>
	<div class="item">
		<a class="item" data-type="1">充值</a>
	</div>
	<div class="item">
		<a data-type="2">签到</a>
	</div>
...
<script>
        ...
        $(".tab a").click(function () {
            ...
            if(!$(this).hasClass("active"))
            {
                ...
                switch(model)
                {
                    case 1:
                    {
                        $(".tab a:eq(3)").removeClass('active');
                        $(".tab a:eq(2)").removeClass('active');
	...
	function load(){
		$.ajax({
			url: "<?php echo U('Member/getRecord');?>",
			type: 'post',
	...
	function appendBills(bills){
        ...
        for (var i in bills) {
            var li = '<div class="item"> <div class="title">' + title + '</div> <div class="body"> <div class="typo-orange">' ;
			if(bills[i].isvip == 1){

    ...
    <div class="shrink open-box condition-box" style="display: block;">
        <div class="row has-label">
            ...
            <div class="container open-type">
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=0" type="tid" val="0" <?php if($cateid == 0): ?>class="active"<?php endif; ?> id="open-all">全部</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=1" type="tid" val="1" <?php if($cateid == 1): ?>class="active"<?php endif; ?> id="open-8">总裁</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=2" type="tid" val="2" <?php if($cateid == 2): ?>class="active"<?php endif; ?> id="open-12">穿越</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=3" type="tid" val="3" <?php if($cateid == 3): ?>class="active"<?php endif; ?> id="open-1">校园</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=4" type="tid" val="4" <?php if($cateid == 4): ?>class="active"<?php endif; ?> id="open-11">恐怖</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=5" type="tid" val="5" <?php if($cateid == 5): ?>class="active"<?php endif; ?> id="open-3">古风</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=6" type="tid" val="6" <?php if($cateid == 6): ?>class="active"<?php endif; ?> id="open-2">恋爱</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=7" type="tid" val="7" <?php if($cateid == 7): ?>class="active"<?php endif; ?> id="open-13">奇幻</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=8" type="tid" val="8" <?php if($cateid == 8): ?>class="active"<?php endif; ?> id="open-4">热血</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=9" type="tid" val="9" <?php if($cateid == 9): ?>class="active"<?php endif; ?> id="open-5">悬疑</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=10" type="tid" val="10" <?php if($cateid == 10): ?>class="active"<?php endif; ?> id="open-6">耽美</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=11" type="tid" val="11" <?php if($cateid == 11): ?>class="active"<?php endif; ?> id="open-7">都市</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=12" type="tid" val="12" <?php if($cateid == 12): ?>class="active"<?php endif; ?> id="open-9">爆笑</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&cateid=13" type="tid" val="13" <?php if($cateid == 13): ?>class="active"<?php endif; ?> id="open-14">真人</a></div>
            </div>
        </div>
        <div class="row has-label">
            <label class="label"><span>状态</span></label>
            <div class="container">
                <div class="item"><a href="<?php echo U('book_cate');?>&status=0" type="end" val="0" <?php if($status == 0): ?>class="active"<?php endif; ?> >全部</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&status=1" type="end" val="1" <?php if($status == 1): ?>class="active"<?php endif; ?> >连载</a></div>
                <div class="item"><a href="<?php echo U('book_cate');?>&status=2" type="end" val="2" <?php if($status == 2): ?>class="active"<?php endif; ?> >完结</a></div>
            </div>
        </div>
        <div class="row has-label">

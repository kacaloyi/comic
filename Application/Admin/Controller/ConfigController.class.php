		...
		if(IS_POST){
			...
			foreach($_POST['money'] as $key => $val){
				if(empty($val)){
					...
					empty($_POST['isVIP'][$key]) && $_POST['isVIP'][$key] = 0;
					empty($_POST['title'][$key]) && $_POST['title'][$key] = "";
					empty($_POST['ads'][$key]) && $_POST['ads'][$key] = "";
					empty($_POST['tip'][$key]) && $_POST['tip'][$key] = "";
				}
